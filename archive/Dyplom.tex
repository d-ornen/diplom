...
\title{Architektura Shadow Deploy dla funkcji 5G Core z wykorzystaniem Kubernetes i Istio} % INFO: tytuł pracy w języku polskim 
\titleShort{Shadow Deploy dla 5G Core}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
\titleEN{Shadow Deployment Architecture for 5G Core Functions using Kubernetes and Istio} % INFO: tytuł pracy w języku angielskim
\author{Hainutdzinau Artsiom}  % INFO: imię i nazwisko autora
\uczelnia{Politechnika Wrocławska} % INFO: nazwa uczelni
\wydzial{Wydział Informatyki i Telekomunikacji} % INFO: nazwa wydziału
\kierunek{Teleinformatyka (TIN)} % IFO: nazwa kierunku
\specjalnosc{Utrzymanie sieci teleinformatycznych (TIU)} % INFO: nazwa specjalności
\promotor{dr inż. Marcin Głowacki} % INFO: dane promotora 
\kvpl{5G Core, Service-Based Architecture, Shadow Deploy, Kubernetes, Istio, Envoy, Traffic Mirroring, SMF, UDR, Obserwowalność, SLO, Prometheus, Iter8, CI/CD, Cloud Native Network Functions} % INFO: słowa kluczowe po polsku
\kven{5G Core, Service-Based Architecture, Shadow Deploy, Kubernetes, Istio, Envoy, Traffic Mirroring, SMF, UDR, Observability, SLO, Prometheus, Iter8, CI/CD, Cloud Native Network Functions} % INFO: słowa kluczowe po angielsku
